import sys
sys.path.append("/mnt/wsl/repos/aoc21")
from utils import read_lines_as_text

TESTING = False

if TESTING:
    in_file = "/mnt/wsl/repos/aoc21/09/test_input.txt"
else:
    in_file = "/mnt/wsl/repos/aoc21/09/input.txt"
...
def get_col(mat, x, y):
    y_left = max(0, y - 1)
    y_right = min(y + 1, len(mat))
    return mat[y_left][x], mat[y][x], mat[y_right][x]
